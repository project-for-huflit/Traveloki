const {
  LichSuDatXeOto,
} = require("../models/lichSuDatXeOto.model");

const {
  DatXeOto,
} = require("../models/datXeOto.model");

const {
  LichSuDatXeBus,
} = require("../models/lichSuDatXeBus.model");

const {
  PhieuDatXeBus,
} = require("../models/phieuDatXeBus.model");

const {
  LichSuDatTau,
} = require("../models/lichSuDatTau.model");

const {
  PhieuDatTau,
} = require("../models/phieuDatTau.model");
